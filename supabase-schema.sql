...
-- Fixes a misspelled or mistyped name without losing anything — unlike
-- admin_remove_member(), this keeps the player's existing picks and
-- points attached, just under the corrected name.
